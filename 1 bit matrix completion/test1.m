...
0% gradient descent
eta = 450; % objective increases dramatically when eta=460
           % eta=440 and eta=450 have almost the same performance, but we still tune the best one. The other methods are similar. 
[tloss0,tgrad0,loss0,grad0,time0] = gd(data_all,I_all,J_all,siz,maxit,eta);

1% our Algorithm 2
eta = 90; % objective increases dramatically when eta=100
...
2% our Algorithm 4
eta = 210; % objective increases dramatically when eta=220
