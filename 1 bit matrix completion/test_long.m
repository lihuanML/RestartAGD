...
%%%%%%%%%%%%%%%%%%%%%%%%%%% run each algorithm %%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Note: we run the faster algorithm for 20000 iteratinos and use the minimum objective value to approximate the unknown optimal one, which will be used to plot the figures.
...
axis([0,10000,1e-4,10]);
set(gca,'ytick',[1e-4,1e-2,10]);
set(gca,'Fontsize',20);
legend('Ada-RAGD-NC','Ada-RHB-NC');
