...
for k = 1:N                        % run N iterations
    ...
    [gradU,gradV] = grad_1mc(data_train,I_train,J_train,Mat,len,U,V);
    % calculate the gradient at (U,V)
    ...
    OBJ1(k) = funvalue_1mc(data_train,I_train,J_train,len,U,V);                   % objective function value at the kth iteration
